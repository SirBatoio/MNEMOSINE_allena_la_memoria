...
public class Intruso extends AppCompatActivity {
    ...
    private final ArrayList<Categoria> fruit = new ArrayList<>();
    private final ArrayList<Categoria> vestiti = new ArrayList<>();
    private final ArrayList<Categoria> temp = new ArrayList<>();
    private final ArrayList<Categoria> ruote = new ArrayList<>();
    private final ArrayList<Categoria> noruote = new ArrayList<>();
    private final ArrayList<Categoria> veggie = new ArrayList<>();
    private final ArrayList<Categoria> mammiferi = new ArrayList<>();
    private final ArrayList<Categoria> ovipari = new ArrayList<>();
    private final ArrayList<Categoria> felini = new ArrayList<>();
    ...
    public void riempiGallerie() {
        ...
        vestiti.add(vestaut);
        vestiti.add(vestinv);
        vestiti.add(vestprim);
        transp.add(bici);
        transp.add(auto);
        transp.add(barca);
        transp.add(moto);
        transp.add(camion);
        transp.add(elicottero);
        transp.add(carro);
        transp.add(monopattino);
        transp.add(quad);
        transp.add(camper);
        animal.add(cane);
        animal.add(gatto);
        ...
        ruote.add(auto);
        ruote.add(camion);
        ruote.add(monopattino);
        ruote.add(quad);
        ruote.add(camper);
        noruote.add(barca);
        noruote.add(carro);
        noruote.add(elicottero);
        veggie.add(carota);
        veggie.add(patata);
        veggie.add(rapa);
        mammiferi.add(elefante);
        mammiferi.add(cane);
        mammiferi.add(gatto);
        mammiferi.add(leone);
        mammiferi.add(tigre);
